...
main :: IO ()
main = interact $ show . numberLoadbearing . applyGravity . map parse . lines

numberLoadbearing :: [Block] -> Int
numberLoadbearing bs = sum [1 | b <- bs, let bs' = delete b bs, bs' == applyGravity bs']
